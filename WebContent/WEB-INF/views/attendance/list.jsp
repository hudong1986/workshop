...
<div id="page-inner">
	<div class="row">
		<div class="col-md-12">
			<h1 class="page-head-line">员工考勤</h1>
		</div>
	</div>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<s:url value="/attendance/list" var="submit_rul" />
					<sf:form class="form-inline" action="${submit_rul }" method="post"
						...
						<div class="form-group">
							...
							<select class="form-control" name="type">
								<option value="-1" ${type=="-1" ? "selected=selected" : "" }>全部类型</option>
								<option value="1" ${type==1 ? "selected=selected" : "" }>请假</option>
								<option value="2" ${type==2 ? "selected=selected" : "" }>加班</option>
							</select>
						...
						<table class="table table-hover">
							<thead class="theadStyle">
								<tr>
									...
									<th><a
										href="<s:url value="/attendance/list?${pager.orderString1}" />">
									...
									<c:when test="${pager.totalCount>0}">
										...
										<c:forEach var="item" items="${pager.data }">
											<tr>
												...
												<td><fmt:formatDate value="${item.begTime}"
			...
			<div class="col-md-4">
				<nav aria-label="...">
					<ul class="pager">
						<li><a
							href="<s:url value="/attendance/list?${pager.prePageString}" />">上一页</a></li>
						<li><a
							href="<s:url value="/attendance/list?${pager.nextPageString}" />">下一页</a></li>
					</ul>
				</nav>
			</div>
		</div>
